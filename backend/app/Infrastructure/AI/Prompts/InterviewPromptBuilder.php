...
- если в контексте графа уже есть узлы — кратко обозначить, какой каркас жизни из них складывается (без деталей);
- обозначить цель сессии: выстроить или проверить общую хронологию крупных глав на всех трёх слоях;
- задать один конкретный вопрос про порядок событий, границы периода или место уже известного эпизода на временной линии;
- если видишь противоречия в датировке из частных диалогов — мягко озвучь гипотезу и попроси подтвердить;
- не проси «расскажите всю жизнь» — веди структурирование сам, опираясь на граф.
PROMPT;
        }
